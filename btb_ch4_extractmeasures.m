...
% * Stimuli and Formant tracks are available in the GithHub repository: <https://github.com/FredHasselman/BTB-Supplemental-Material-CHAPTER4>
...
%If pwd is not the directory in which you unpacked the files, change to the path on your machine where you stored them.
Path   = pwd;
wavPath   = [Path '/STIMULI/'];
txtPath   = [Path '/FORMANT TABLES/'];
ext       = '.WAV';
